...
}, datasetParams?: DatasetParams, props?: Record<string, any>) => void;
...
export interface ExternalRenderProps {
...
export interface SpecificChartConfig {
    ...
    onResize?: any;
    render?: React.ComponentType<ExternalRenderProps>;
}
export interface ExternalChart {
    types: Record<string, SpecificChartConfig>;
    moduleType: 'chart';
}
export interface ExternalPlugin {
    moduleType: 'plugin';
}
export declare type ExternalModule = ExternalChart | ExternalPlugin;
