...
declare class Chart {
     ...
     */
    private hasData;
    private getExternalRenderProps;
    /**
     * 绘制dom类型图表
     */
    private renderDomChart;
    setOption: ({ option, notMerge, lazyUpdate, type, data, datasetParams, plugins, ...components }: SetOption) => void;
    private renderChart;
...
declare const _default: {
    ...
    use: (externalModule: import("./types").ExternalModule) => void;
};
