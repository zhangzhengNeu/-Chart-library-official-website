    ...
    ***************************************************************************** */
    ...
    var lookUpParent = function (routeOrTarget) {
        if (Array.isArray(routeOrTarget)) {
            return routeOrTarget.find(function (d) { return isValidSniffingDom(d.dataset); });
        }
    ...
    var transFormTrackParams = function (dataset) {
        ...
        try {
            ...
            console.error(EXCEPTION.ParamsParseError, err);
        }
        return formatEv;
    };
    var transFormExpoTrackParams = function (params) {
        return transFormTrackParams({
    ...
    var pathIsEqual = function (path, rep) {
        if (!rep)
            return false;
        var matchBrowserUrl = match(rep, { decode: decodeURIComponent });
        return matchBrowserUrl(path);
    };

    var util = /*#__PURE__*/Object.freeze({
        isListenerType1: isListenerType1,
        isListenerType2: isListenerType2,
        bindEventListener: bindEventListener,
        isValidSniffingDom: isValidSniffingDom,
        isValidSniffingExpoDom: isValidSniffingExpoDom,
        isExpoed: isExpoed,
        getTrackParams: getTrackParams,
        lookUpParent: lookUpParent,
        transFormTrackParams: transFormTrackParams,
        transFormExpoTrackParams: transFormExpoTrackParams,
        env: env,
     ...
     * @Descripttion:
     */
    var routerEventEmitter = new events.EventEmitter();
    ...
    var routerObserver = (function (options) {
    ...
    var Exposure = /** @class */ (function () {
        ...
        Exposure.prototype.init = function () {
            ...
            this.observer = new IntersectionObserver(function (entries, observer) {
                entries.forEach(function (item) {
                    var dataset = lodash.get(item, 'target.dataset', {});
                    if (isExpoed(dataset) || !isValidSniffingExpoDom(dataset)) {
                        observer.unobserve(item.target);
                    }
                    else if (item.isIntersecting) {
                        var data = transFormExpoTrackParams(dataset);
        ...
        Exposure.prototype.setMutaion = function () {
            var fn = lodash.debounce(this.observerAll, 500).bind(this);
            if (!MutationObserver) {
    ...
    var notSupport = typeof window === 'undefined' || typeof console === 'undefined';
    var Log = (function (prefix, isDebugger //全局注入打印日志的级别（多少）TODO: 暂时未用到
    ) {
        if (prefix === void 0) { prefix = 'Sniffing: '; }
        if (isDebugger === void 0) { isDebugger = false; }
        return function (text, level) {
            ...
            var info = typeof text === 'string' ? "" + prefix + text : text;
            if (level === 'error') {
                errorLog(info);
                return;
            }
    ...
    var SniffingClass = /** @class */ (function () {
        ...
        SniffingClass.prototype.xmrep = function (xmrepInstance, options, isReturn) {
            ...
            xmrepInstance(Object.assign(options, {
                c: __assign(__assign({}, customCommon), { sdkVersion: '@xmly/sniffing-sdk-2.0.0' })
            }));
            if (isReturn) {
                return this;
            }
        ...
        SniffingClass.prototype.init = function (trackerMap, options) {
            ...
            if (this._init) {
                this.log(ENVIRONMENT.REPEAT, 'warn');
                return this;
            }
            this._init = true;
        ...
        SniffingClass.prototype.install = function (trackerMap, extend) {
            ...
            if (!this._init) {
                this.log(NOTFOUND.SniffingNotReady, 'warn');
                return this;
            }
        ...
        SniffingClass.prototype[EXCUTEUBTTTACKER] = function (trackParams) {
            ...
            if (findOne.length) {
                ...
                if (this.options.autoTrack) {
                    ...
                    this.log(NOTFOUND.UnregistedId + "(id: " + trackParams.evId + ")", 'warn');
                }
            }
        };
        /**
        ...
        SniffingClass.prototype.manualTrack = function (evId, ubtParams) {
            this[EXCUTEUBTTTACKER](transFormTrackParams({ evId: evId, ubtParams: ubtParams, evTrigger: 'event' }));
        };
        /**
         * @description: log
         * @param {any} text
    ...
    /*
     * @Date: 2020-11-09 10:10:28
     * @LastEditTime: 2021-01-20 16:09:03
     * @Descripttion:
     */
    var sniffing = new SniffingClass();

    exports.default = sniffing;
    exports.utilTool = util;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=sniffing-sdk.umd.js.map
