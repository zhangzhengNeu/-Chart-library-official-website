 ...
 * 页面加载时间、渲染数据
 */
var CPerformance = /** @class */ (function () {
    function CPerformance(opt) {
        this.performance = window.performance;
        this.fnRouteMap = opt.fnRouteMap;
    }
    CPerformance.prototype.start = function () {
        var _this = this;
        if (this.check()) {
    ...
    CPerformance.prototype.check = function () {
        return (window.addEventListener
            && this.performance
            && this.performance.timing);
    };
    CPerformance.prototype.getData = function () {
